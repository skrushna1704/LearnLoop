  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Enhanced Header */}
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 rounded-3xl p-8 text-white">
          <div className="relative z-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              <div>
                <h1 className="text-4xl font-bold mb-2">
                LearnLoop Community</h1>
                <p className="text-blue-100 text-lg">Where knowledge flows freely and everyone grows together</p>
          ...
          <main className="col-span-12 lg:col-span-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-4 flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <Button variant="ghost" className="text-gray-500 hover:text-gray-900 w-full justify-start rounded-full">
                  What&apos;s on your mind, {user?.profile?.name?.split(' ')[0] || 'User'}?
                </Button>
              </div>
              <Button onClick={() => router.push('/community/create-post')} className="rounded-full">
                Create Post
              </Button>
            </div>
            ...
            {posts.length === 0 && !loading && (
              <div className="text-center py-16">
                <p className="text-lg text-gray-600">No posts yet. Be the first to share!</p>
              </div>
            )}
          </main>

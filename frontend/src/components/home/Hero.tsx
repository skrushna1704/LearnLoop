      ...
      <div className="relative section-container section-padding">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 animate-fade-in-up animate-delay-100">
              Teach & Learn Skills — Together
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-2xl animate-fade-in-up animate-delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animate-delay-300 mb-6">
              {user ? (
                  ...
                  <>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-blue-900">Add skills you can teach</div>
                          <div className="text-sm text-blue-700">Share your expertise (e.g., Web Development, Cooking)</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-purple-50 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-purple-900">Add skills you want to learn</div>
                          <div className="text-sm text-purple-700">Find teachers for skills you want to master</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-green-900">Exchange and learn together</div>
                          <div className="text-sm text-green-700">Connect with others for mutual skill exchange</div>
                        </div>
                      </div>
                    </div>
